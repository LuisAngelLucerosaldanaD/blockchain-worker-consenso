...
func NewParticipant(id string, lotteryId string, walletId string, amount float64, accepted bool, typeCharge int, returned bool) *Participant {
	return &Participant{
		ID:         id,
		LotteryId:  lotteryId,
		WalletId:   walletId,
...
func (m *Participant) valid() (bool, error) {
