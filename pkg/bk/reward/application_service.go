...
type PortsServerReward interface {
...
type service struct {
	repository ServicesRewardRepository
	user       *models.User
	txID       string
}

func NewRewardService(repository ServicesRewardRepository, user *models.User, TxID string) PortsServerReward {
